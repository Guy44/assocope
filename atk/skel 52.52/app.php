 ...
 * Chargement des textes, messages, tooltips
 ...
 * Contrôle acceptation du contrat d'utilisation
 * Contrôle accès restreint : pas de top frame ni de menu frame
 * 
...
/*	{  echo "<pre>";
	...
	echo "<br><br>".'XXXXX $_SESSION de la SESSION ID '.session_id.' :<br/>';
	print_r ($_SESSION);
	global $g_sessionData;
	echo "<br><br>".'XXXXX $g_sessionData :<br/>';
	print_r ($g_sessionData);
	echo "<br><br>".'XXXXX $g_user :<br/>';
	print_r ($g_user);
	echo "</pre>";
	die ();
	}
