 ...
 * the error handler
 */
require_once atkconfig("atkroot") . 'modules/search/libraries/Error_Handler.class.php';
...
if (empty($__redirect) && !defined('PMA_NO_VARIABLES_IMPORT')) {
    require atkconfig("atkroot") . 'modules/search/libraries/grab_globals.lib.php';
}
 ...
 */
require_once atkconfig("atkroot") . 'modules/search/libraries/session.inc.php';
...
if (! PMA_isValid($_REQUEST['token']) || $_SESSION[' PMA_token '] != $_REQUEST['token']) {
     ...
     */
    require_once atkconfig("atkroot") . 'modules/search/libraries/cleanup.lib.php';
    /**
     * Do actual cleanup
     */
 ...
 */
require_once atkconfig("atkroot") . 'modules/search/libraries/select_lang.lib.php';
echo 'FIN GG common.inC';
die();
/**
...
if (! defined('PMA_MINIMUM_COMMON')) {
     ...
     */
    require_once atkconfig("atkroot") . 'modules/search/libraries/charset_conversion.lib.php';

    /**
     * String handling
     */
    require_once atkconfig("atkroot") . 'modules/search/libraries/string.lib.php';
    ...
    if (function_exists('mb_convert_encoding')
     && strpos($lang, 'ja-') !== false) {
        require_once atkconfig("atkroot") . 'modules/search/libraries/kanji-encoding.lib.php';
        /**
    ...
    if (! empty($cfg['Server'])) {
         ...
         */
        require_once atkconfig("atkroot") . 'modules/search/libraries/database_interface.lib.php';

        require_once atkconfig("atkroot") . 'modules/search/libraries/logging.lib.php';
        ...
        if (! file_exists(atkconfig("atkroot") . 'modules/search/libraries/auth/' . $cfg['Server']['auth_type'] . '.auth.lib.php')) {
            PMA_fatalError($strInvalidAuthMethod . ' ' . $cfg['Server']['auth_type']);
        }
        /**
         * the required auth type plugin
         */
        require_once atkconfig("atkroot") . 'modules/search/libraries/auth/' . $cfg['Server']['auth_type'] . '.auth.lib.php';
        ...
        if (isset($cfg['Server']['AllowDeny'])
          && isset($cfg['Server']['AllowDeny']['order'])) {
             ...
             */
            require_once atkconfig("atkroot") . 'modules/search/libraries/ip_allow_deny.lib.php';
         ...
         * SQL Parser code
         */
        require_once atkconfig("atkroot") . 'modules/search/libraries/sqlparser.lib.php';

        /**
         * SQL Validator interface code
         */
        require_once atkconfig("atkroot") . 'modules/search/libraries/sqlvalidator.lib.php';

        /**
         * the PMA_List_Database class
         */
        require_once atkconfig("atkroot") . 'modules/search/libraries/PMA.php';
        $pma = new PMA;
    ...
    require_once atkconfig("atkroot") . 'modules/search/libraries/blobstreaming.lib.php';
