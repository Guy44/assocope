 ...
 *
 */
require_once atkconfig("atkroot") . 'modules/search/libraries/file_listing.php';
require_once atkconfig("atkroot") . 'modules/search/libraries/plugin_interface.lib.php';
require_once atkconfig("atkroot") . 'modules/search/libraries/display_import_ajax.lib.php';

/* Scan for plugins */
$import_list = PMA_getPlugins(atkconfig("atkroot") . 'modules/search/libraries/import/', $import_type);

/* Fail if we didn't find any plugin */
if (empty($import_list)) {
    PMA_Message::error('strCanNotLoadImportPlugins')->display();
    require atkconfig("atkroot") . 'modules/search/libraries/footer.inc.php';
}
?>
