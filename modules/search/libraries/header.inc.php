...
if (empty($GLOBALS['is_header_sent'])) {
     ...
     */
    require_once atkconfig("atkroot") . 'modules/search/libraries/ob.lib.php';
    PMA_outBufferPre();
    ...
    require_once atkconfig("atkroot") . 'modules/search/libraries/header_http.inc.php';
    require_once atkconfig("atkroot") . 'modules/search/libraries/header_meta_style.inc.php';
    require_once atkconfig("atkroot") . 'modules/search/libraries/header_scripts.inc.php';
    ?>
    ...
    if (PMA_DISPLAY_HEADING && $GLOBALS['server'] > 0) {
        ...
        if (strlen($GLOBALS['db'])) {
            ...
            if (strlen($GLOBALS['table'])) {
                require_once atkconfig("atkroot") . 'modules/search/libraries/tbl_info.inc.php';
