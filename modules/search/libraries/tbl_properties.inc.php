...
require_once atkconfig("atkroot") . 'modules/search/libraries/mysql_charsets.lib.php';
require_once atkconfig("atkroot") . 'modules/search/libraries/StorageEngine.class.php';

/**
 * Class for partition management
 */
require_once atkconfig("atkroot") . 'modules/search/libraries/Partition.class.php';
