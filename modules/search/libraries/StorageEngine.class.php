...
class PMA_StorageEngine
{
    ...
    static public function getEngine($engine)
    {
        ...
        if (file_exists(atkconfig("atkroot") . 'modules/search/libraries/engines/' . $engine_lowercase_filename . '.lib.php')
          && include_once atkconfig("atkroot") . 'modules/search/libraries/engines/' . $engine_lowercase_filename . '.lib.php') {
