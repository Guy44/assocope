...
if (defined('PMA_MULTIBYTE_ENCODING') || $GLOBALS['PMA_allow_mbstr']) {
    ...
    require atkconfig("atkroot") . 'modules/search/libraries/string_mb.lib.php';
} else {
    $GLOBALS['PMA_strpos']      = 'strpos';
    $GLOBALS['PMA_substr']      = 'substr';
    require atkconfig("atkroot") . 'modules/search/libraries/string_native.lib.php';
}
...
if ($GLOBALS['PMA_allow_ctype']) {
    ...
    require atkconfig("atkroot") . 'modules/search/libraries/string_type_ctype.lib.php';
} else {
    $GLOBALS['PMA_STR_isAlnum'] = 'PMA_STR_isAlnum';
    $GLOBALS['PMA_STR_isDigit'] = 'PMA_STR_isDigit';
    $GLOBALS['PMA_STR_isSpace'] = 'PMA_STR_isSpace';
    require atkconfig("atkroot") . 'modules/search/libraries/string_type_native.lib.php';
}
