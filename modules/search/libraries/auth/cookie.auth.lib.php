 ...
 */
require atkconfig("atkroot") . 'modules/search/libraries/auth/swekey/swekey.auth.lib.php';
...
if (function_exists('mcrypt_encrypt')) {
    ...
    require_once atkconfig("atkroot") . 'modules/search/libraries/blowfish.php';
...
function PMA_auth()
{
    ...
    require atkconfig("atkroot") . 'modules/search/libraries/header_meta_style.inc.php';
    ?>
...
<h1>
    ...
    if (empty($GLOBALS['cfg']['Lang'])) {
        require_once atkconfig("atkroot") . 'modules/search/libraries/display_select_lang.lib.php';
...
<?php } ?>
    ...
    if (count($GLOBALS['cfg']['Servers']) > 1) {
        ...
        require_once atkconfig("atkroot") . 'modules/search/libraries/select_server.lib.php';
