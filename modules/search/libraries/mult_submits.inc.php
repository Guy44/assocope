...
if (!empty($submit_mult) && !empty($what)) {
    ...
    require_once atkconfig("atkroot") . 'modules/search/libraries/header.inc.php';
    if (strlen($table)) {
        require atkconfig("atkroot") . 'modules/search/libraries/tbl_common.php';
        $url_query .= '&amp;goto=tbl_sql.php&amp;back=tbl_sql.php';
        require atkconfig("atkroot") . 'modules/search/libraries/tbl_info.inc.php';
        require_once atkconfig("atkroot") . 'modules/search/libraries/tbl_links.inc.php';
    } elseif (strlen($db)) {
        ...
        require_once atkconfig("atkroot") . 'modules/search/libraries/server_common.inc.php';
        require_once atkconfig("atkroot") . 'modules/search/libraries/server_links.inc.php';
    }
...
elseif ($mult_btn == $strYes) {
    ...
    if ($query_type == 'drop_db' || $query_type == 'drop_tbl' || $query_type == 'drop_fld') {
        require_once atkconfig("atkroot") . 'modules/search/libraries/relation_cleanup.lib.php';
    }
