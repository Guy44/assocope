...
require_once atkconfig("atkroot") . 'modules/search/libraries/bookmark.lib.php';
 ...
 */
require_once atkconfig("atkroot") . 'modules/search/libraries/db_table_exists.lib.php';
